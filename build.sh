...
g++ -Os -fno-exceptions -fno-rtti -Isrc/glad_gles20/include -L_CMAKE/_GLFW/src -o _build/dir_light examples/dir_light.cpp src/glad_gles20/src/glad.c src/*.cpp -lglfw3 -ldl -lpthread -lX11
